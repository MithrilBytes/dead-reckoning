...
Exact versions install on both, because every platform marker in this resolution
either names Windows or sits behind an extra nothing here asks for. The Python
version shapes the resolution as well, so it goes into the first line of the file
and is compared along with the pins.
